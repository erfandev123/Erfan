...
> = {
  'customer-support': {
    ...
    description:
      'Handle customer inquiries and see how function calls can automate tasks.',
    prompts: [
  ...
  jarvis: {
    title: 'Jarvis',
    description:
      'A sophisticated, witty AI assistant. Control your environment and get information.',
    prompts: [
      'Play a song by Daft Punk.',
      'Set a 5 minute timer.',
      'Turn on the light and make it purple.',
    ],
  },
};
